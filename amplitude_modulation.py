...
def SubBands_Decomposition(Signal, Fs, Bands=[(0.5,4),(4,8),(8,12),(12,30),(30,100)], Filt='FIR_filter'):
    """
...
def Modulation_Bands_Decomposition(SubBand_Signal, Fs, M_Bands = [(0.5,4),(4,8),(8,12),(12,30),(30,100)], Filt='FIR_filter'):
    """
...
def Modulation_Bands_Decomposition_Hamming(SubBand_Signal, Fs, M_Bands = [(0.5,4),(4,8),(8,12),(12,30),(30,100)]):
    """
